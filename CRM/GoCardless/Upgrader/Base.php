 ...
 */
class CRM_GoCardless_Upgrader_Base {
  ...
  public static function instance() {
    if (!self::$instance) {
      // FIXME auto-generate
      self::$instance = new CRM_GoCardless_Upgrader(
        'uk.artfulrobot.civicrm.gocardless',
        realpath(__DIR__ . '/../../../')
      );
    }
   ...
   *
   * @code
   * CRM_GoCardless_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * @endcode
   */
